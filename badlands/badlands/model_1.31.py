    ...
    def run_to_time(self, tEnd, verbose=False):
        ...
        while self.tNow < tEnd:
           ...
           # if self.input.tStart != self.tNow:
            ...
            co_flow = self.flow
            co_fvmesh = self.FVmesh
            co_elevation = self.elevation 
            co_fillh = self.fillH
            co_cumdiff = self.cumdiff
            co_cumhill = self.cumhill
            co_cumfail = self.cumfail
            co_cumflex = self.strata
            co_lgids = self.lGIDs
            co_mapero = self.mapero
            co_force = self.force
            co_hillslope = self.hillslope
            co_strata =  self.strata
            co_flex = self.flex
            co_prop = self.prop
            co_rain = self.rain
            ...
            # # copy back 
            # self.flow = co_flow 
            # self.FVmesh = co_fvmesh  
            # self.elevation = co_elevation  
            # self.cumdiff = co_cumdiff  
            # self.cumhill = co_cumhill 
            # self.cumfail = co_cumfail 
            # self.lGIDs = co_lgids 
            # self.mapero = co_mapero 
            # self.force = co_force
            # self.hillslope = co_hillslope
            # self.strata  = co_strata 
            # self.flex = co_flex
            # self.prop = co_prop 
            # self.rain = co_rain 
